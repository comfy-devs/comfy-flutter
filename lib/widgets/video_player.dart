...
class VideoPlayerWidgetState extends State<VideoPlayerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final w = widget.orientation == Orientation.portrait
        ? MediaQuery.of(context).size.width
        : (MediaQuery.of(context).size.height * (16 / 9));
    final h = widget.orientation == Orientation.portrait
        ? (MediaQuery.of(context).size.width / (16 / 9))
        : MediaQuery.of(context).size.height;
    final btnSize = widget.orientation == Orientation.portrait ? 48.0 : 96.0;
    final btnIconSize =
        widget.orientation == Orientation.portrait ? 36.0 : 64.0;
        ...
        child: SizedBox(
            ...
            child: Stack(children: [
              ...
              Visibility(
                ...
                child: VideoPlayerCaptionWidget(
                    controller: controller, orientation: widget.orientation),
              ),
              AnimatedOpacity(
              ...
              AnimatedOpacity(
                  ...
                  child: Visibility(
                      ...
                      child: Stack(children: [
                        GestureDetector(onTap: () => {controlsShow(false)}),
                        Wrap(
                            ...
                            children: [
                              SizedBox(
                                  ...
                                  child: Stack(
                                      ...
                                      children: [
                                        Image.asset(
                                            "assets/icons/web/skip-back-96x96.png",
                                            width: btnIconSize * 0.75,
                                            height: btnIconSize * 0.75),
                                        InkWell(
                                            onTap: () => {
                                                  controlsSeekOutTimer = Timer(
                                                      const Duration(
                                                          milliseconds: 200),
                                                      () =>
                                                          {controlsShow(false)})
                                            ...
                                            onDoubleTap: () => {
                                                  controlsSeekOutTimer
                                                      ?.cancel(),
                                                  processControlsSeek(controller
                                                          .value
                                                          .position
                                                          .inSeconds -
                                                      10)
                                      ...
                                      children: [
                                        Image.asset(
                                            controller.value.isPlaying
                                                ? "assets/icons/web/pause-96x96.png"
                                                : "assets/icons/web/play-96x96.png",
                                            width: btnIconSize,
                                            height: btnIconSize),
                                        InkWell(onTap: processControlsPlay)
                                      ])),
                              SizedBox(
                                  width: ((w - btnSize) * 0.5),
                                  height: h,
                                  child: Stack(
                                      ...
                                      children: [
                                        Image.asset(
                                            "assets/icons/web/skip-forward-96x96.png",
                                            width: btnIconSize * 0.75,
                                            height: btnIconSize * 0.75),
                                        InkWell(
                                            onTap: () => {
  ...
  void controlsResetFadeAutoTimer() {
    controlsFadeAutoTimer?.cancel();
    controlsFadeAutoTimer =
        Timer(const Duration(seconds: 3), () => {controlsShow(false)});
  }
}
