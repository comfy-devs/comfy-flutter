...
class ShowCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final title = item.title.length < 18
        ? item.title
            ...
            child: Stack(children: [
              SizedBox(
                  ...
                  child: CachedNetworkImage(
                      imageUrl:
                          '${state.preferences.imageEndpoint}/${item.id}/poster.webp',
                  ...
                  child: Container(
                      ...
                      child: Wrap(
                          ...
                          children: [
                            Text(title,
                                style: TextStyle(
                                    color: Colors.white, fontSize: fs0)),
                            Text(item.favourites.toString(),
                                style: TextStyle(
                                    color: const Color(0xffff3645),
                                    fontSize: fs0)),
                            Image.asset('assets/icons/web/star-48x48.png',
                                width: fs0, height: fs0)
                          ]))),
              Visibility(
                  visible: extra != null,
                  child: Positioned(
